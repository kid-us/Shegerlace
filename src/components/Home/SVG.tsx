...
const SVG = ({ bg }: Props) => {
  const [viewBox, setViewBox] = useState("23 23 150 150");

  useEffect(() => {
    const handleResize = () => {
      if (window.innerWidth >= 1024) {
        setViewBox("10 14 175 175");
      } else {
        setViewBox("23 23 150 150");
      }
    };

    window.addEventListener("resize", handleResize);
    handleResize(); // Call it once to set the initial viewBox
