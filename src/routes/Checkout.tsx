      ...
      {success && (
        <>
          ...
          <div className="fixed top-0 left-0 flex z-50 justify-center items-center h-[100dvh] w-full lg:px-0 px-3">
            <div className="lg:w-[25%] w-full hero-bg rounded px-5 py-10 bg-white shadow shadow-zinc-900">
              <div className="flex justify-between w-full">
                <h2 className="text-black text-2xl font-bold">Submitted</h2>
              ...
              <p className="text-sm text-black my-5">
                ...
                will be granted access to track your order. Stay tuned!
              </p>
              <div className="flex justify-center text-center">
                <a
                  href="/"
                  className="btn-bg w-80 hover:scale-95 transition-all duration-200 p-3 rounded text-sm"
                >
                  Browse More
                </a>
              </div>
          ...
          {id !== "cart" ? (
            <div className="lg:px-20 lg:sticky top-20 self-start border-r border-gray-300 text-white">
              <div className="lg:py-16 md:py-16 px-3 py-5 text-black">
                ...
                <p className=" text-lg mt-2">Quantity: {qty}</p>
