...
const ProductDetail = () => {
  ...
  useEffect(() => {
    // Mock data
    setTimeout(() => {
      const shoeData = getShoeById(id || "");
      if (shoeData) {
        setShoe(shoeData);
        setActiveImage(shoeData.main_picture);

        // Sizes
        const newSizes = [];
        for (
          let i = getSizeRange(shoeData.size_range).startSize;
          i <= getSizeRange(shoeData.size_range).endSize;
          i++
        ) {
          newSizes.push(i);
        }
  ...
  // const access_token = localStorage.getItem("token"); // Commented out
  ...
  return (
    <>
      ...
      <div>
        <div className="lg:grid grid-cols-5 gap-x-10 lg:mt-20 mt-16">
          {/* Images */}
          {shoe && (
            <Images
          ...
          <div className="col-span-2 w-96">
            <div className="ps-4">
              ...
              <p className="mt-4 font-poppins font-bold text-2xl">
                <span className="text-2xl "></span> {shoe?.price} ETB
              </p>
            </div>
            ...
            <div className="px-4">
              {/* Size */}
              <p className="mt-5 text-zinc-700 text-sm">Select Size</p>
              <div
                className={`${
                  error && "border border-red-500 pb-5 rounded p-1 mt-3"
                }`}
              >
                <div className="grid grid-cols-4 mt-3 gap-2">
                  {sizes.map((s) => (
                    <button
                      ...
                      className={`lg:w-18 lg:h-16 w-full h-14 border border-gray-300 rounded shadow- ${
                        size === s
                          ? "bg-black text-white"
              ...
              {/* Description */}
              <p className="mt-8 text-sm text-zinc-600">Description</p>
              <p className="mt-1">{shoe?.description}</p>
              ...
              <div className="grid grid-cols-6 rounded">
                <button
                  ...
                  className={`bi-dash shadow-sm shadow-zinc-900 hover:shadow-none ${
                    quantity === 1 ? "bg-gray-400 shadow-none" : "btn-bg"
                ...
                <div className="col-span-4 h-12">
                  <input
                    type="number"
                    className="focus:outline-none h-12 text-center w-full text-xl  border-zinc-400 border-t border-b"
                    value={quantity}
                ...
                <button
                  ...
                  className={`bi-plus shadow-sm shadow-zinc-900 hover:shadow-none ${
              ...
              <div className="mt-6 space-y-4">
                ...
                <button
                  ...
                  className="bg-black text-white w-full rounded-lg lg:h-12 h-14 shadow-sm shadow-zinc-950 transition-all duration-300 hover:shadow-none"
                >
                  Add to Bag{" "}
                ...
                {shoe && favoriteShoe.includes(shoe.id) && (
                  <button
                    ...
                    className="bg-red-600 text-white w-full rounded-lg lg:h-12 h-14 shadow-sm shadow-zinc-950 transition-all duration-300 hover:shadow-none"
                  >
                    Remove for Favorite{" "}
                ...
                {shoe && !favoriteShoe.includes(shoe.id) && (
                  <button
                    ...
                    className="bg-white w-full rounded-lg lg:h-12 h-14 shadow-sm shadow-zinc-950 transition-all duration-300 hover:shadow-none"
                  >
        ...
        {/* Similar items */}
        <p className="lg:mt-10 mt-20 font-bold text-xl px-4">
          You might also like
        </p>
        {shoe && <SimilarItem brand={shoe?.brand} id={shoe.uid} />}
      </div>
      <Footer />
    </>
  );
...
//                     }
//                     className="btn-bg block text-center pt-1 font-bold font-poppins text-lg lg:w-72 w-full rounded-lg lg:h-12 h-14 shadow-sm shadow-zinc-950 transition-all duration-300 hover:shadow-none"
//                   >
//                     Order
//                   </button>
//                 ) : (
...
//                 <button
//                   onClick={() => handleAddToBag()}
//                   className="bg-black text-white lg:w-72 w-full rounded-lg lg:h-12 h-14 shadow-sm shadow-zinc-950 transition-all duration-300 hover:shadow-none"
//                 >
//                   Add to Bag{" "}
//                   <span className="bi-bag-fill ms-3 text-white"></span>
//                 </button>
...
//                       handleFavorite(shoe.id);
//                     }}
//                     className="bg-red-600 text-white lg:w-72 w-full rounded-lg lg:h-12 h-14 shadow-sm shadow-zinc-950 transition-all duration-300 hover:shadow-none"
//                   >
//                     Remove for Favorite{" "}
//                     <span className="bi-heart-fill ms-3"></span>
//                   </button>
...
//                       handleFavorite(shoe.id);
//                     }}
//                     className="bg-white lg:w-72 w-full rounded-lg lg:h-12 h-14 shadow-sm shadow-zinc-950 transition-all duration-300 hover:shadow-none"
//                   >
//                     Add to Favorite <span className="bi-heart-fill ms-3"></span>
//                   </button>
//                 )}
